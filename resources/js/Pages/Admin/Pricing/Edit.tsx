...
export default function Edit({ auth, pricing }: { auth: any, pricing: Pricing }) {
    const { data, setData, put, processing, errors } = useForm({
        name: pricing.name || '',
        description: pricing.description || '',
        price_monthly: pricing.price_monthly || '',
        price_annually: pricing.price_annually || '',
        currency: pricing.currency || 'USD',
        period: pricing.period || '/ project',
        features: pricing.features || [''],
        cta_text: pricing.cta_text || 'Get Started',
        cta_link: pricing.cta_link || '',
        is_popular: pricing.is_popular || false,
    });

    const handleSubmit = (e: FormEvent) => {
        e.preventDefault();
        put(route('admin.pricing.update', pricing.id));
    };
        ...
        <AdminLayout user={auth.user}>
            ...
            <form onSubmit={handleSubmit} className="max-w-4xl mx-auto space-y-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h2 className="text-3xl font-serif text-gray-900">Edit Plan</h2>
                        <p className="text-gray-500">Update pricing details for {pricing.name}.</p>
                    </div>
                </div>
